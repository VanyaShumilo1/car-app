...
const DeleteIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0,0,256,256"
             width="50px" height="50px" fillRule="nonzero">
            <g fill="#a0a0a0" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt"
